...
type
  TClientDataProcessor = class(TwclCustomClientDataProcessor)
  private
    ...
    function Write(const Data: TByteArray): Int32;
  ...
  public
    ...
    function WriteData(const Data: Byte): Int32; reintroduce; overload;
    function WriteData(const Data: UInt16): Int32; reintroduce; overload;
    function WriteData(const Data: UInt32): Int32; reintroduce; overload;
    function WriteData(const Data: UInt64): Int32; reintroduce; overload;

    function WriteData(const Data: SByte): Int32; reintroduce; overload;
    function WriteData(const Data: Int16): Int32; reintroduce; overload;
    function WriteData(const Data: Int32): Int32; reintroduce; overload;
    function WriteData(const Data: Int64): Int32; reintroduce; overload;

    function WriteData(const Data: TByteArray): Int32; reintroduce; overload;
    function WriteData(const Data: string): Int32; reintroduce; overload;

    function GetSByte: Int32;
    function GetInt16: Int32;
    function GetInt32: Int32;
    function GetInt64: Int32;

    function GetByte: Int32;
    function GetUInt16: Int32;
    function GetUInt32: Int32;
    function GetUInt64: Int32;

    function GetArray: Int32;
    function GetString: Int32;
...
procedure TClientDataProcessor.ByteReceived(Sender: TObject;
  const Data: Byte);
begin
...
function TClientDataProcessor.GetArray: Int32;
begin
  Result := Write(Common.Create(CMD_GET_ARRAY));
end;

function TClientDataProcessor.GetByte: Int32;
begin
  Result := Write(Common.Create(CMD_GET_BYTE));
end;

function TClientDataProcessor.GetInt16: Int32;
begin
  Result := Write(Common.Create(CMD_GET_INT16));
end;

function TClientDataProcessor.GetInt32: Int32;
begin
  Result := Write(Common.Create(CMD_GET_INT32));
end;

function TClientDataProcessor.GetInt64: Int32;
begin
  Result := Write(Common.Create(CMD_GET_INT64));
end;

function TClientDataProcessor.GetSByte: Int32;
begin
  Result := Write(Common.Create(CMD_GET_SBYTE));
end;

function TClientDataProcessor.GetString: Int32;
begin
  Result := Write(Common.Create(CMD_GET_STRING));
end;

function TClientDataProcessor.GetUInt16: Int32;
begin
  Result := Write(Common.Create(CMD_GET_UINT16));
end;

function TClientDataProcessor.GetUInt32: Int32;
begin
  Result := Write(Common.Create(CMD_GET_UINT32));
end;

function TClientDataProcessor.GetUInt64: Int32;
begin
  Result := Write(Common.Create(CMD_GET_UINT64));
end;
...
var
  ArrData: TByteArray;
begin
  if (Size > 0) and (Data <> nil) then begin
...
procedure TClientDataProcessor.SByteReceived(Sender: TObject;
  const Data: SByte);
begin
...
function TClientDataProcessor.Write(const Data: TByteArray): Int32;
begin
  Result := inherited Write(Pointer(Data), Length(Data));
end;

function TClientDataProcessor.WriteData(const Data: Byte): Int32;
begin
  Result := Write(Common.Create(Data, False));
end;

function TClientDataProcessor.WriteData(const Data: UInt16): Int32;
begin
  Result := Write(Common.Create(Data, False));
end;

function TClientDataProcessor.WriteData(const Data: UInt32): Int32;
begin
  Result := Write(Common.Create(Data, False));
end;

function TClientDataProcessor.WriteData(const Data: UInt64): Int32;
begin
  Result := Write(Common.Create(Data, False));
end;

function TClientDataProcessor.WriteData(const Data: SByte): Int32;
begin
  Result := Write(Common.Create(Data, True));
end;

function TClientDataProcessor.WriteData(const Data: Int16): Int32;
begin
  Result := Write(Common.Create(Data, True));
end;

function TClientDataProcessor.WriteData(const Data: Int32): Int32;
begin
  Result := Write(Common.Create(Data, True));
end;

function TClientDataProcessor.WriteData(const Data: Int64): Int32;
begin
  Result := Write(Common.Create(Data, True));
end;

function TClientDataProcessor.WriteData(const Data: TByteArray): Int32;
begin
...
function TClientDataProcessor.WriteData(const Data: string): Int32;
begin
  if (Length(Data) = 0) or (Length(Data) > High(UInt16) - 3) then
    Result := WCL_E_INVALID_ARGUMENT
  else
